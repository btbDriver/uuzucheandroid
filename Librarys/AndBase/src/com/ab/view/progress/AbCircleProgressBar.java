...
//    private int[] arcColors = new int[]{0xFF02C016, 0xFF3DF346, 0xFF40F1D5, 0xFF02C016};
    ...
    public int[] arcColors = new int[]{0xFF55acef, 0xFF55acef, 0xFF55acef, 0xFF55acef};//进度条往下走的颜色
    public int pathColor = 0xFF032525;//背景色
    public int pathBorderColor = 0x0055acef;//背景边框色
    // 环的路径宽度
