...
public class MonthView extends LinearLayout {
    ...
    public static MonthView create(ViewGroup parent, LayoutInflater inflater,
        ...
        for (int offset = 0; offset < 7; offset++) {
            ...
            textView.setText(weekText[offset]);
        }
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (i < numRows) {
                ...
                for (int c = 0; c < week.size(); c++) {
                    ...
                    cellView.setBanday(cell.isBanDay());
                    cellView.setUpHalfBanDay(cell.isUpHalfBanDay());
                    cellView.setDownHalfBanDay(cell.isDownHalfBanDay());
