...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (expandRoot.getVisibility() != View.VISIBLE) {
            return;
        }
...
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
        ...
        mButton.setBackgroundResource(mCollapsed ? R.drawable.ic_expand_small_holo_light : R.drawable.ic_collapse_small_holo_light);
        if (mCollapsed) {
            expand_text.setText("展开");
        } else {
            expand_text.setText("收起");
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        expandRoot.setVisibility(View.GONE);
        mTv.setMaxLines(Integer.MAX_VALUE);
        MLog.e("ExpandableTextView", "mMaxCollapsedLines = " + mMaxCollapsedLines + "   textLine = " + mTv.getLineCount());
        // Measure
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        ...
        expandRoot.setVisibility(View.VISIBLE);
...
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
        ...
        expandRoot = (RelativeLayout) findViewById(R.id.expand);
        expandRoot.setVisibility(View.GONE);
        expandRoot.setOnClickListener(this);
    }
