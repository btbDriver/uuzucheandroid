...
//        View view = getContext().getLayoutInflater().inflate(R.layout.stroke_intent_item, null);
        ...
        tab.setSingleLine();
        tab.setId(R.id.msg);
        final TextView news = new TextView(getContext());
        ...
        layoutParams2.addRule(RelativeLayout.RIGHT_OF, R.id.msg);
        layoutParams2.topMargin = Config.px2dip(getContext(), 27);
        news.setLayoutParams(layoutParams2);
        news.setGravity(Gravity.CENTER);
        news.setTextColor(getContext().getResources().getColor(R.color.c11));
        relativeLayout.addView(news);
        news.setWidth(Config.dip2px(getContext(), 11));
        news.setHeight(Config.dip2px(getContext(), 11));
        news.setText("");
        news.setBackgroundResource(R.drawable.radius_text_bg);
        news.setVisibility(View.GONE);
        /**
         * 是否显示靠观察者通知
         */
        ObserverManager.addObserver(title, new ObserverListener() {
            @Override
            public void observer(String from, Object obj) {
                ...
                try {
                    ...
                    if (Integer.parseInt((String) obj) > 0) {
                        news.setWidth(Config.dip2px(context, 20));
                        news.setHeight(Config.dip2px(context, 20));
                        news.setText((String) obj);
    ...
    private void updateTabStyles(int position) {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof RelativeLayout) {
                ...
                tab.setTypeface(tabTypeface);
                if (i == position) {
                    tab.setTextColor(getResources().getColor(R.color.c1));
                } else {
                    tab.setTextColor(getResources().getColor(R.color.subtitle_color));
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft, height * 35 / 38 - underlineHeight, lineRight, height - underlineHeight,
                rectPaint);
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            if (delegatePageListener != null) {
                ...
                setTextColor(0XFF00CCFF, position);
            }
        }
