...
//                mAllFramelayout.makeProgreeNoData();
    ...
    public static MyStrokeFinishFragment newInstance() {
        MyStrokeFinishFragment instance = new MyStrokeFinishFragment();
        return instance;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        nodata_tip.setText("您还没有已完成的订单");
        requestModel.queryType = OrderFormCommon.TripListQueryType.COMPLETED;
        ...
        ObserverManager.addObserver("FinishTip", new ObserverListener() {
            @Override
            public void observer(String from, Object obj) {
                if (obj.equals("show")) {
                    missRoot.setVisibility(View.VISIBLE);
                    missTip.setText("您还有未评价的订单，立即评价得优惠券");
                } else {
