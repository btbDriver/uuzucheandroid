...
/**
 * Created by taurusxi on 14-7-15.
 */
public class OwnerEvaluationRenterActivity extends BaseActivity
{

    public String tag = OwnerEvaluationRenterActivity.class.getSimpleName();
    public Activity context;
    public String   rSn;
    boolean isPlatFormSuccess, isStarSucces;
    ...
    public void submit()
    {
        ...
        if (!isStarSucces)
        {
            Toast.makeText(OwnerEvaluationRenterActivity.this, "请评分后再提交", Toast.LENGTH_SHORT).show();
            return;
        }
